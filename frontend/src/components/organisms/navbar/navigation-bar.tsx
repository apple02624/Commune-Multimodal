...
export default function NavigationBar() {
  const [isShowWalletPaymentModal, setIsShowWalletPaymentModal] =
  ...
  const [
    ...
    setIsShowConnectWithSubstrateModalOpen,
  ] = React.useState(false);
  ...
  const loginStatus = useSelector(
    (state: { transactionRecord: { loginStatus: boolean } }) =>
      state.transactionRecord.loginStatus
  );
  ...
  return (
    <>
      <div className="min-h-full bg-black dark:bg-slate-900">
        <Disclosure as="nav" className="bg-slate-50 bg-opacity-0 shadow-md">
          {({ open }) => (
            <>
                ...
                <div className="flex h-16 items-center justify-end">
                  <div className="hidden md:block">
                    <div className="flex items-center">
                      <Menu as="div" className="flex relative ml-3">
                        <Menu.Button
                          className={classNames(
                            classes.link,
                            "dark:text-white dark:hover:text-[#25c2a0] p-0 md:text-xl"
                          )}
                          aria-haspopup="true"
                          aria-expanded="false"
                          role="button"
                      ...
                      <Menu as="div" className="flex relative ml-3">
                        <div>
                          <Menu.Button
                            ...
                            className={classNames(
                              classes.link,
                              "dark:text-white dark:hover:text-[#25c2a0] p-0 md:text-[18px]"
                            )}
                          >
                            💰Payment
                          </Menu.Button>
                      ...
                      <div
                        className={classes.themeTogglerWrapper}
                ...
                <div className="border-t border-gray-700 pb-3 pt-4">
                  <div className="flex items-center px-5">
                    ...
                    <div className="ml-3">
                      ...
                      <div className="text-sm font-medium leading-none dark:text-white">
                        {user.email}
                      </div>
                    </div>
                    <div
                      className={classNames(
                        classes.themeTogglerWrapper,
                        "ml-auto"
                      )}
                    >
                      <ThemeToggler />
      ...
      {isShowConnectWithSubstrateModalOpen && (
        <Modal
          open={isShowConnectWithSubstrateModalOpen}
          onCancel={handleConnectWithSubstrateModalCancel}
          footer={null}
        >
          <div className="flex flex-col">
            ...
            {chainInfo && nodeName && (
              <div className="flex items-center justify-evenly mt-4">
                Connected to chain{" "}
                <span className="text-cyan-500">{chainInfo}</span> using{" "}
                <span className="text-cyan-500">{nodeName}</span>
              </div>
            )}
          </div>
        </Modal>
      ...
      {isShowWalletPaymentModal && (
        <Modal
          open={isShowWalletPaymentModal}
          onCancel={handleWalletPaymentModalOpen}
          footer={null}
        >
          <div className="flex flex-col">
