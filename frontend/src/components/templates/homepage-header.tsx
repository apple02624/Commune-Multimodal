...
const TITLE = "Commune AI Multimodal";
const TAGLINE = "Any-to-Any Multimodal Large Language Model for";
...
export default function HomepageHeader() {
  ...
  return (
    <header
      ref={headerRef}
      className={`relative z-10 dark:bg-gray-900 text-center h-screen overflow-hidden ${getHeaderClasses(
        scrollPosition,
        headerHeight
      )} duration-500 bg-[url('/img/Multimodal-AI.jpg')] bg-opacity-5 bg-cover`}
      id="dashboard"
    >
        ...
        <div className="px-10 py-5">
          <div className="flex lg:flex-row flex-col h-1/2">
            <div className="w-full flex flex-col items-center justify-center">
              ...
              <div className="h-[3rem] mt-4 flex justify-between gap-3 items-center">
                <div
